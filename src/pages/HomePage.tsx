        ...
        <View style={[styles.container, { backgroundColor: theme.background }]}>
            <View style={[styles.header, { backgroundColor: headerBg }]}>
                ...
                <View style={styles.headerRight}>
                    <FocusableView 
                        style={[styles.recommendButton, { backgroundColor: PRIMARY_COLOR_HEX} ]} 
                        focusBorderColor={SECONDARY_COLOR} 
                        onPress={() => onNavigate('Recommend')} 
                        ferredFocus={true}>
                        <MaterialCommunityIcons name="movie-search" size={15} color="white" />
                        <Text  style={styles.buttonText}>更多推荐</Text>
                    </FocusableView>
                    <FocusableView
